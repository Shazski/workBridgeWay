...
const Footer = () => {
    return (
        <div className="bg-gray-900 w-full text-gray-400 mt-6">
            <div className="flex ms-14 md:ms-32 pt-10">
                ...
                <div className="notifications  pt-10 md:w-3/12">
                    ...
                    <div className="mt-5 xl:flex gap-3">
                        ...
                        <button className="py-2 bg-green-500 text-white px-4 mt-3 md:mt-0 rounded-md">Subscribe</button>
                    </div>
                </div>
            </div>
        </div>
