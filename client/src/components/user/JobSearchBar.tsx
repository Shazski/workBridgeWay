    ...
    <div>
      <div className="md:flex ms-14 md:ms-36 md:mt-8">
        <div className="bg-white me-10 px-2 mt-6 h-18 relative">
          ...
          <button onClick={() => navigate(`/jobs?search=${search}`)} className="bg-lightgreen mb-4 sm:ms-8 md:mb-3 px-3 py-3 mt-6 md:mt-2 md:ms-14 text-white text-center font-semibold rounded-sm">Seach my Job</button>
        </div>
