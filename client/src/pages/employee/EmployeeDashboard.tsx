          ...
          <div className="flex w-full mt-7">
            {isScheduleDataValid && (
              <div className="flex gap-y-4 w-1/6 flex-col">
                ...
                <h1 className="text-xs">{formatTimeToAMPM(sortedScheduleData?.[idx]?.time)}   "---------"</h1>
                <h1 className="text-xs">{formatAdjustedTimeToAMPM(sortedScheduleData?.[idx]?.time, 1)}</h1>
              </div>
            )}
            <div className="border 4/6 flex px-4 py-2 h-16 mt-2 rounded-lg gap-x-5 bg-light-blue-50">
