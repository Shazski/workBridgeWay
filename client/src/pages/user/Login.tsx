            ...
            <div className='md:w-4/6 w-11/12'>
                ...
                <div className='text-center pt-12'>
                    <Formik
                        ...
                        <Form>
                            <div>
                                <Field type="text" placeholder='Email' name="email" className='border ps-2 rounded-md h-12 w-64' />
                                <ErrorMessage name="email" component="div" className="text-red-600" />
                            </div>
                            <div className='flex justify-center relative'>
                                <Field name="password" type={showPassword ? "text" : "password"} placeholder='Password' className='border  ps-2 rounded-md h-12 w-64 mt-5' />
